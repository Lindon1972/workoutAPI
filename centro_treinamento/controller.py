...
@router.post('/', summary='Criar CT', status_code=status.HTTP_201_CREATED, response_model=CentroTreinamentoOut,)
...
@router.get('/{id}', summary='Consultar Centro de Treinamento pelo ID', status_code=status.HTTP_200_OK, response_model=CentroTreinamentoOut,)
async def query_by_id(id, db_session: DatabaseDependency) -> CentroTreinamentoOut:
