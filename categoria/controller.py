...
@router.post('/', summary='Criar categoria', status_code=status.HTTP_201_CREATED, response_model=CategoriaOut)
...
async def query_by_id(id, db_session: DatabaseDependency) -> CategoriaOut:
